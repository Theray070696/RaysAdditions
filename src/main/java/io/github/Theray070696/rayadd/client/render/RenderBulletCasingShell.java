 ...
 */
public class RenderBulletCasingShell extends Render
{
    public RenderBulletCasingShell(RenderManager renderManager)
    {
        super(renderManager);
    }
    ...
    {
        return new ResourceLocation("rayadd:render/Shells.png");
    }
}
