 ...
 */
public class RenderBulletRocketLaserClassic extends Render
{
    public RenderBulletRocketLaserClassic(RenderManager renderManager)
    {
        super(renderManager);
    }
    ...
    {
        return new ResourceLocation("rayadd:render/RocketsLaser.png");
    }
}
